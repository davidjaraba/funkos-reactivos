...
public class FunkosReactiveRepoImpl implements FunkosReactiveRepo {
    ...
    public static synchronized FunkosReactiveRepoImpl getInstance(DatabaseManager databaseManager, IdGenerator idGenerator) {
        if (instance == null) {
            instance = new FunkosReactiveRepoImpl(databaseManager, idGenerator);
        }
        return instance;
    }

    private FunkosReactiveRepoImpl(DatabaseManager databaseManager, IdGenerator idGenerator) {
